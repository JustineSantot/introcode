$( document ).ready(function() {
  ...
  function welcome() {
   $("#welcome").html('<h4>Bienvenue, <br> sois pret à renouveler tes défis !</h4>');
...
function getUsername() {
    ...
    var  user = prompt("Rentre ton nom pour accéder à de nouveaux défis:", "");
...
function welcome() {
    ...
    $("#welcome").html('<h4>Bienvenue '+name+', <br> sois pret à renouveler tes défis ! </h4>');
...
function loadChallenges() {
  $.ajax(
        {url : 'https://api.myjson.com/bins/171myb',
        type: 'GET',
        dataType: 'json'} 
  )
  .done(function(data) {
